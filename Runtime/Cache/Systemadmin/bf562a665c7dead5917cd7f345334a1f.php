...
<body> 
<div class="right-nav">
      <a class="home" href="" title=""></a><div class="con"><span style="color:#33ccff;">首页</span> > 美育启蒙管理</div>
</div>

<div class="right-title">
      美育启蒙管理<a href="<?php echo U(MODULE_NAME.'/Enlighten/add');?>" title="">[添加]</a>
</div>
      ...
      <table class="table">
            ...
            <tr> 
                  ...
                  <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="enlighten">
                    ...
                    <div class="action"><span class="modify"><a href="<?php echo U(MODULE_NAME.'/Enlighten/edit',array('id'=>$v['id']));?>">[修改]</a></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="delete"><a onclick="return del()" href="<?php echo U(MODULE_NAME.'/Enlighten/delete',array('id'=>$v['id']));?>">[删除]</a></span></div>
