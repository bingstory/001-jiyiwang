...
<body> 
<div class="right-nav">
      <a class="home" href="" title=""></a><div class="con"><span style="color:#33ccff;">首页</span> > 个性化定制</div>
</div>

<div class="right-title">
      个性化定制<a href="<?php echo U(MODULE_NAME.'/Customize/addNews');?>" title="">[添加]</a>
</div>

      <table class="table">
      <tr>
                  <form action="<?php echo U(MODULE_NAME.'/Customize/index');?>" method="post">
                  <td colspan="5"> 
            ...
            <?php if(is_array($news)): foreach($news as $key=>$v): ?><tr> 
                  ...
                  <td align="right">
                    ...
                    [<a href="<?php echo U(MODULE_NAME.'/Customize/newsEdit',array('id'=>$v['id'],'cate_id'=>$cate_id));?>">修改</a>]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    [<a onclick="return del()" href="<?php echo U(MODULE_NAME.'/Customize/delete',array('id'=>$v['id'],'cate_id'=>$cate_id));?>">删除</a>]
