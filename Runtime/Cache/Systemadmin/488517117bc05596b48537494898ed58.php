...
<body>
<div class="right-nav">
      <a class="home" href="" title=""></a><div class="con"><span style="color:#33ccff;">首页</span> > 美育启蒙编辑</div>
</div>

<div class="right-title">
      美育启蒙编辑
</div>
       <form action="<?php echo U(MODULE_NAME.'/Enlighten/doEdit');?>" method="post" enctype="multipart/form-data">
            <table class="table">
