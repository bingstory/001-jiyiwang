...
<body>
<div class="right-nav">
      <a class="home" href="" title=""></a><div class="con"><span style="color:#33ccff;">首页</span> > 个性化定制编辑</div>
</div>

<div class="right-title">
      个性化定制编辑
</div>
       <form action="<?php echo U(MODULE_NAME.'/Customize/doNewsEdit');?>" method="post" enctype="multipart/form-data">
            <table class="table">
