...
<body>
<div class="right-nav">
      <a class="home" href="" title=""></a><div class="con"><span style="color:#33ccff;">首页</span> > 添加新闻</div>
</div>

<div class="right-title">
      添加新闻
</div>
       <form action="<?php echo U(MODULE_NAME.'/News/doAddNews');?>" method="post" enctype="multipart/form-data">
            <table class="table">
