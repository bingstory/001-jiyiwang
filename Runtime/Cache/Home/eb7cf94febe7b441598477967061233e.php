...
<a href="<?php echo U('/'.MODULE_NAME.'/avideoshow_'.$v['id'].'_'.$artist_id);?>"><img src="/001-jiyiwang/<?php echo ($v["picurl"]); ?>" width="207" height="120" /></a>
<p><a href="<?php echo U('/'.MODULE_NAME.'/avideoshow_'.$v['id'].'_'.$artist_id);?>"><?php echo (msubstr($v["summary"],0,25)); ?>[详情]</a></p>
