...
<div class="sj_title"><ul>
  ...
  <div class="sj_bott">
    ...
    <div id="search3">
<form action="<?php echo U(MODULE_NAME.'/User/doRegByEmail');?>" method="post">
<p><span class="fl_l s_text"><em style=" color:#fd4140" >*</em> 姓名</span> <span class="fl_r input_s"><input name="" type="text" /></span></p>
<p><span class="fl_l s_text"><em style=" color:#fd4140" >*</em> 邮箱</span> <span class="fl_r input_s"><input name="" type="text" /></span></p>
<p class="input_bo"><span >我们非常珍惜与您的邮件沟通机会，确保为您提供专享且价值高的内容</span></p>
...
<p> <span class="fl_r input_v"><img src="/001-jiyiwang/Public/Home/images/zz2.jpg" width="87" height="30"> 看不清，<span><a href="#">换一张</a></span></span></p>
...
只需要花上1分钟来创建集艺网通行证，您就可以轻松的访问金蝶的高价值资源，包含集艺网视频、艺术、书籍、服务等。
    ...
    $(function(){
      $('#loginsubmit').click(function(){
        $.ajax({
            url:"<?php echo U(MODULE_NAME.'/User/loginform','','');?>",
            type:'POST',
            data:{
