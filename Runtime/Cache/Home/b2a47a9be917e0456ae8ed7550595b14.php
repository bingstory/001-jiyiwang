...
<div class="p_pic2">
<ul>
<?php if(is_array($shop)): foreach($shop as $key=>$v): ?><li <?php if(($key+1) % 5 == 0): ?>class="last"<?php endif; ?>><a href="<?php echo U('/'.MODULE_NAME.'/gs_'.$v['id'].'_'.$artist_id);?>"><img src="/001-jiyiwang/<?php echo ($v["thumb2"]); ?>" width="156" height="200" /></a>
        <div class="jianjie">
            <p><a href="<?php echo U('/'.MODULE_NAME.'/gs_'.$v['id'].'_'.$artist_id);?>"><?php echo (msubstr($v["title"],0,11,0)); ?></a></p>
