...
$('.todetail').click(function(){
    $(this).parent('p').replaceWith("<p class='toreplace'>111<?php echo ($v["content"]); ?><a class='todetail'>[收起]</a></p>");
})
});
</script>
<style>.bedetail{}</style>
...
<div id="p_b3_bottom">
<ul>
<?php if(is_array($dynamic)): foreach($dynamic as $key=>$v): ?><li>
<h2><span class="fl_l zj_bt"><?php echo ($v["title"]); ?></span><span class="fl_r zj_time"> <strong><?php echo ($v["celebrityname"]); ?></strong> <?php echo (date("Y-m-d",$v["pubtime"])); ?></span></h2>
<p class="toreplace"><?php echo (msubstr($v["content"],0,100)); ?><a class="todetail">[详细]</a></p>
<span></span>
