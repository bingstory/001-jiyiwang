...
<div id="c_box2">
    <div class="fl_l c_b2_left">
        <div class="c_b2_title"><span class="fl_l c2_l"><span class="fl_l"><img src="/001-jiyiwang/Public/Home/images/cp1_19.jpg" width="27" height="27" /></span> &nbsp;&nbsp;<span class="fl_r"><strong><?php if(empty($position)): ?>集艺新闻<?php else: echo ($position); endif; ?></strong></span></span><span class="fl_r c2_r">位置：<a href="<?php echo U('/Home/news');?>">集艺新闻</a><?php if(empty($position)): else: ?> > <?php echo ($position); endif; ?></span></div>
        <div id="gao"></div>
        <div class="c_b2_text">
     ...
     <div id="gao3"></div>
         ...
         <div class="l_page"><span class="fl_l p1"><?php echo ($front); ?></span><span class="fl_r p2"><?php echo ($after); ?></span></span></div>
