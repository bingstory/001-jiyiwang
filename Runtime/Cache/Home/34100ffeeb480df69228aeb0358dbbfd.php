...
<script>
var URL = "<?php echo U(MODULE_NAME.'/Public/like','','');?>";
var URL2 = "<?php echo U(MODULE_NAME.'/Public/concern','','');?>";
</script>
<script src="/001-jiyiwang/Public/Home/js/like.js"></script>
...
<div class="p_b2_pic">
<ul>
<?php if(is_array($shop5)): foreach($shop5 as $key=>$v): ?><li <?php if($key+1 == 5): ?>class="last"<?php else: endif; ?>><a href="<?php echo U('/'.MODULE_NAME.'/gs_'.$v['id'].'_'.$artist['id']);?>"><img src="/001-jiyiwang/<?php echo ($v["thumb2"]); ?>" width="156" height="200" /></a>
<div class="jianjie">
 <p><a href="<?php echo U('/'.MODULE_NAME.'/gs_'.$v['id'].'_'.$artist['id']);?>"><?php echo (msubstr($v["title"],0,11,0)); ?></a></p>
...
<div id="p_gao"></div>
<div id="p_box3">
    <div class="p_b3_title">
        <div class="fl_l l_t1"><span><strong>个人动态</strong></span>  / DYNAMIC</div>
        <div class="fl_r r_t2">MORE>></div>
    </div>

<div id="p_b3_bottom">
<ul>
<?php if(is_array($dynamic)): $i = 0; $__LIST__ = array_slice($dynamic,0,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if(($mod) == "1"): ?>class="last"<?php endif; ?>>
<h2><?php echo (msubstr($v["title"],0,70,0)); ?></h2>
<p><?php echo (msubstr($v["content"],0,140)); ?></p>
...
<div id="p_box4">
    <div class="p_b4_title">
        <div class="fl_l l_t1"><span><strong>作品欣赏</strong></span>  / SHOW</div>
...
<ul>
<?php if(is_array($works)): $i = 0; $__LIST__ = $works;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 4 );++$i;?><li <?php if(($mod) == "3"): ?>class="last"<?php endif; ?>>
<h1><a href="<?php echo U('/'.MODULE_NAME.'/aworksshow_'.$v['id'].'_'.$artist['id']);?>"><img src="/001-jiyiwang/<?php echo ($v["thumb"]); ?>" width="206" height="185" /></a></h1>
<div class="xushu">
<h2><a class="tored" href="<?php echo U('/'.MODULE_NAME.'/aworksshow_'.$v['id'].'_'.$artist['id']);?>"><?php echo (msubstr($v["title"],0,12,0)); ?></a></h2>
<p><span class="fl_l time"><?php echo ($v["createyear"]); ?>年作</span>
    <span class="fl_r zan"><img class="cursor clickconcern" data="<?php echo ($v["id"]); ?>" src="/001-jiyiwang/Public/Home/images/pic1_97.jpg" /> &nbsp;<span id="concern<?php echo ($v["id"]); ?>"><?php echo ($v["concern"]); ?></span>&nbsp;&nbsp;<img class="cursor clicklike" data="<?php echo ($v["id"]); ?>" src="/001-jiyiwang/Public/Home/images/pic1_94.jpg" /> &nbsp;<span id="like<?php echo ($v["id"]); ?>"><?php echo ($v["favor"]); ?></span></span></p>
</div>
</li><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
...
<div id="p_box5">
    <div class="p_b5_title">
        <div class="fl_l l_t1"><span><strong>名家评价</strong></span>  / COMMENTS</div>
        <div class="fl_r r_t2">MORE>></div>
    </div>

<div id="p_b5_bottom">
<ul>
<?php if(is_array($celebritycomment)): $i = 0; $__LIST__ = array_slice($celebritycomment,0,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if(($mod) == "1"): ?>class="last"<?php endif; ?>>
<h2><?php echo (msubstr($v["title"],0,70,0)); ?></h2>
<p><?php echo (msubstr($v["content"],0,140)); ?></p>
</li><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div id="p_gao"></div>
<div id="p_box6">
    <div class="p_b6_title">
        <div class="fl_l l_t1"><span><strong>视频</strong></span>  / VIDEO</div>
        <div class="fl_r r_t2">MORE>></div>
    </div>
<div class="p_b6_bottom">
<ul>
<?php if(is_array($video)): $i = 0; $__LIST__ = $video;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 4 );++$i;?><li <?php if(($mod) == "3"): ?>class="last"<?php endif; ?>>
<h2><?php echo (msubstr($v["title"],0,10,0)); ?><span><img src="/001-jiyiwang/Public/Home/images/sjx.jpg" width="7" height="13" /></span></h2>
<a href="#"><img src="/001-jiyiwang/<?php echo ($v["picurl"]); ?>" width="207" height="120" /></a>
<p><a href="#"><?php echo (msubstr($v["summary"],0,25)); ?>[详情]</a></p>
