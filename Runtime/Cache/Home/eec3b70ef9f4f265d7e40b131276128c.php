...
<div class="fl_r home_1"><span class="fl_l"><img src="/001-jiyiwang/Public/Home/images/home1.jpg" width="17" height="17" /></span> <span class="fl_r"><a href="/001-jiyiwang">返回首页</a></span></div>
...
<form name="regForm" action="<?php echo U(MODULE_NAME.'/User1/doRegByEmail');?>" method="post">
  <p>
    <span class="fl_l s_text"> <em style=" color:#fd4140" >*</em>
      用户名
    </span>
    <span class="fl_r input_s">
    <input name="username" type="text" /><label name="username"></label>
    </span>
  </p>
  <p>
    <span class="fl_l s_text"> <em style=" color:#fd4140" >*</em>
    ...
    <span class="fl_r input_s">
      <input name="email" type="text" /><label name="email"></label>
    </span>
  </p>
  <p class="input_bo">
    <span >我们非常珍惜与您的邮件沟通机会，确保为您提供专享且价值高的内容</span>
  </p>
  <p>
    <span class="fl_l s_text">
      <em style=" color:#fd4140" >*</em>
      密码
    </span>
    <span class="fl_r input_s">
      <input name="password" type="password" /><label name="password"></label>
    </span>
  </p>
  <p>
    <span class="fl_l s_text">
    ...
    <span class="fl_r input_s">
      <input name="confirmpwd" type="password" /><label name="confirmpwd"></label>
    </span>
  </p>
   <p>
  <span class="fl_l s_text">
  ...
  <span class="fl_r input_s">
    <input name="code" type="text" /><label name="code"></label>
  </span>
</p>

<p>
  <span class="fl_r input_v">
    <img id="code" src="<?php echo U(MODULE_NAME.'/Public/codeimg','','');?>" width="87" height="30">
    看不清，
    <span>
      <a onclick="changecode();" style="cursor:pointer;">换一张</a>
    </span>
  </span>
</p>

<div class="danxuan">
  <input class="J_CheckBoxItem" type="checkbox" id="items">
  我确认以上信息的准确性,并同意集艺网的
  <span>服务条款</span>
</div>
<div class="tijiao">
 
    <img onclick="" id="submitimg" src="/001-jiyiwang/Public/Home/images/tijiao.jpg" width="204" height="37" />
