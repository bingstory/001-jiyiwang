...
<div id="star_box2">
    <div class="fl_l st_b2_left">
        <div class="st_b2_title"><span class="fl_l st2_l"><span class="fl_l"><img src="/001-jiyiwang/Public/Home/images/cp1_19.jpg" width="27" height="27" /></span> &nbsp;&nbsp;<span class="fl_r"><strong>学习中心</strong></span></span><span class="fl_r c2_r">位置：<a href="#">美育启蒙</a> > 学习中心</span></div>
        <div id="gao"></div>
        <div class="my_bottom">
        <div class="my_pic">
        <ul>

        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li <?php if(($key+1)%3 == 0): ?>class="last"<?php else: endif; ?>><p><a href="<?php echo U('/'.MODULE_NAME.'/ens_'.$v['id']);?>"><img src="/001-jiyiwang/<?php echo ($v["picurl"]); ?>" width="199" height="128" /></a></p>
        <h4>作品名称：<span><?php echo (msubstr($v["title"],0,10,0)); ?></span></h4>
         <h4>详细介绍：<span><?php echo (msubstr($v["summary"],0,25)); ?></span></h4> 
        </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        </div>
        <div class="page_list" style=" clear:both"><?php echo ($page); ?></div>
  ...
  <div class="vtitle">美育启蒙</div>
    <div class="vcon">
    <ul class="vconlist clearfix">
    <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="my"><a href="<?php echo U('/'.MODULE_NAME.'/enlighten_'.$v['id']);?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
  </div>
