...
<div id="jj_bottom">
<div class="fl_l jj_text">
<h1><?php echo ($artist["chinesename"]); ?></h1>
<p> &nbsp;&nbsp;&nbsp;&nbsp;<?php echo (msubstr($artist["summary"],0,110)); ?></p>
<div class="jj_zp">
<p><span class="fl_l jj_t1"><strong>中文名：</strong><span><?php echo ($artist["chinesename"]); ?></span></span><span class="fl_r jj_t2"><strong>职业：</strong><span><?php echo ($artist["career"]); ?></span></span></p>
<p><span class="fl_l jj_t1"><strong>国籍：</strong><span><?php echo ($artist["country"]); ?></span></span><span class="fl_r jj_t2"><strong>毕业院校：</strong><span><?php echo ($artist["graduate"]); ?></span></span></p>
<p><span class="fl_l jj_t1"><strong>出生日期：</strong><span><?php echo ($artist["birthday"]); ?></span></span><span class="fl_r jj_t2"><strong>主要成就：</strong><span><?php echo ($artist["achievement"]); ?></span></span></p>
<p><span class="fl_r jj_t3"><strong>代表作品：</strong><span><?php echo (msubstr($artist["represent"],0,12,0)); ?></span></span></p>
</div>
</div>
<div class="fl_r jj_pic"><img src="/001-jiyiwang/<?php echo ($artist["portrait"]); ?>" width="168" height="218" /><p>作品<span>（20张）</span></p></div>
...
<div class="jj_text_b">
 <fieldset class="border">
   <legend> <h1><span><img src="/001-jiyiwang/Public/Home/images/red.jpg" width="30" height="24" /></span>个人简介</h1> </legend>
<?php echo ($artist["introduction"]); ?>
  </fieldset>
 </div> 
</div>
