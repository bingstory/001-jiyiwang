...
<div id="sx_box">
    ...
    <p><strong>年份</strong></p>
      <div class="years">
      <div class="fl_l all">全部</div>
      <div class="fl_r yf">
      <ul>
      <?php if(is_array($years)): $i = 0; $__LIST__ = array_slice($years,0,15,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('/'.MODULE_NAME.'/yworks_'.$artist['id'].'_'.$v);?>"><?php echo ($v); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
      </div>
      </div>
    
    <p><strong>全部分类</strong></p>
    <div class="fenlei">
    <ul>
    <?php if(is_array($artistcate)): $i = 0; $__LIST__ = array_slice($artistcate,0,7,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('/'.MODULE_NAME.'/cworks_'.$artist['id'].'_'.$v['id']);?>"><?php echo (msubstr($v["name"],0,10,0)); ?>（<?php echo ($workscount[$v['id']]); ?>个作品）</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
...
<ul>
<?php if(is_array($works)): $i = 0; $__LIST__ = $works;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 3 );++$i;?><li <?php if(($mod) == "2"): ?>class="last"<?php endif; ?>>
...
<div class="xushu">
<h2><?php echo (msubstr($v["title"],0,11,0)); ?></h2>
<p><span class="fl_l time"><?php echo ($v["createyear"]); ?>年作</span>
<span class="fl_r zan"><a href="<?php echo U('/'.MODULE_NAME.'/aworksshow_'.$v['id'].'_'.$artist['id']);?>"><img src="/001-jiyiwang/Public/Home/images/pic1_97.jpg"></a> &nbsp;<?php echo ($v["concern"]); ?>&nbsp;&nbsp;<a href="#"><img src="/001-jiyiwang/Public/Home/images/pic1_94.jpg"></a> &nbsp;<?php echo ($v["favor"]); ?></span></p>
</div>
  ...
  <div class="fl_r page_list" style=" clear:both"><?php echo ($page); ?></div> 
