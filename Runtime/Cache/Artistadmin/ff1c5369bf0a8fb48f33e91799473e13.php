...
<div class="right-title">
      添加视频
       ...
       <form action="<?php echo U(MODULE_NAME.'/Homepage/doAddVideo');?>" method="post" enctype="multipart/form-data">
            <table class="table">
                  ...
                  <tr>
                        ...
                        <td>
                              <div style='width:120px; height:100px;'>
                                      <img id="img2" src="/001-jiyiwang/Public/Admin/images/empty_thumb.gif" width="199" height="188" />
