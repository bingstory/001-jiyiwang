...
<tr><td class="td-left">国籍：</td><td class="td-right"><input type="text" name="citizenship" value="<?php echo ($artist["citizenship"]); ?>"></td></tr>
<tr><td class="td-left">所在地：</td><td class="td-right">
  <select name="area" id="">
  <?php if(is_array($area)): foreach($area as $key=>$v): ?><option value="<?php echo ($artist["area_id"]); ?>"><?php echo ($artist["area"]); ?></option>
    <option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
  </select>
</td></tr>
<tr><td class="td-left">籍贯：</td><td class="td-right"><input type="text" name="nativeplace" value="<?php echo ($artist["nativeplace"]); ?>"></td></tr>
<tr><td class="td-left">职业：</td><td class="td-right"><input type="text" name="career" value="<?php echo ($artist["career"]); ?>"></td></tr>
<tr><td class="td-left">职位：</td><td class="td-right"><input type="text" name="position" size="80" value="<?php echo ($artist["position"]); ?>"></td></tr>
<tr><td class="td-left">名言：</td><td class="td-right"><input type="text" name="saying" size="80" value="<?php echo ($artist["saying"]); ?>"></td></tr>
