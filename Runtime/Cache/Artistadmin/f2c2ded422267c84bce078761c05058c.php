    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          ...
          <li><a href="<?php echo U(MODULE_NAME.'/Artist/dynamic');?>" target="main">个人动态</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="<?php echo U(MODULE_NAME.'/Works/index');?>" target="main">作品列表</a></li>
          <li><a href="<?php echo U(MODULE_NAME.'/User/setPassword');?>" target="main">密码管理</a></li>
          <li><a href="<?php echo U(MODULE_NAME.'/Artist/dynamic');?>" target="main">个人动态</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="<?php echo U(MODULE_NAME.'/Works/index');?>" target="main">个人信息</a></li>
          <li><a href="<?php echo U(MODULE_NAME.'/User/setPassword');?>" target="main">密码管理</a></li>
          <li><a href="<?php echo U(MODULE_NAME.'/Artist/dynamic');?>" target="main">个人动态</a></li>
        </ul>
      </div>
