...
<div class="right-title">
     ...
     <form method="post" enctype="multipart/form-data" action="<?php echo U('/'.MODULE_NAME.'/Homepage/doAddAttachment');?>">
      <table class="table">
        <tr>
          <td class="td-left">视频编号：</td><td class="td-right"><?php echo ($works["id"]); ?></td>
        </tr>
        <tr>
          <td class="td-left">视频名称：</td><td class="td-right"><?php echo ($works["title"]); ?></td>
        </tr>
        <tr>
          <td class="td-left">附件名称：</td><td class="td-right"><input type="text" name="name" /></td>
        </tr>
        <tr>
          <td class="td-left">下载所需积分：</td><td class="td-right"><input type="text" name="credits" size="4" />(*只填数字)</td>
        </tr>
        <tr>
          <td class="td-left">封面：</td><td class="td-right">
            <div style='width:120px; height:100px;'>
                                      <img id="img1" src="/001-jiyiwang/Public/Admin/images/empty_thumb.gif" width="127" height="90" />
                                  </div>
                                  (图片大小：127px*90px)
