...
<tr><td class="td-left">国籍：</td><td class="td-right"><?php if(empty($artist['citizenship'])): ?>还没有填写...<?php else: echo ($artist["citizenship"]); endif; ?></td></tr>
<tr><td class="td-left">所在地：</td><td class="td-right"><?php if(empty($artist['area'])): ?>还没有填写...<?php else: echo ($artist["area"]); endif; ?></td></tr>
<tr><td class="td-left">籍贯：</td><td class="td-right"><?php if(empty($artist['nativeplace'])): ?>还没有填写...<?php else: echo ($artist["nativeplace"]); endif; ?></td></tr>
<tr><td class="td-left">职业：</td><td class="td-right"><?php if(empty($artist['career'])): ?>还没有填写...<?php else: echo ($artist["career"]); endif; ?></td></tr>
<tr><td class="td-left">职位：</td><td class="td-right"><?php if(empty($artist['position'])): ?>还没有填写...<?php else: echo ($artist["position"]); endif; ?></td></tr>
<tr><td class="td-left">名言：</td><td class="td-right"><?php if(empty($artist['saying'])): ?>还没有填写...<?php else: echo ($artist["saying"]); endif; ?></td></tr>
